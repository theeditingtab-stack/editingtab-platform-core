...
CORE-003 identity persistence is committed and verified. CORE-004 implements password authentication; CORE-005 implements organization authorization and role audit. CORE-006 implements separate platform authority, one-time operator bootstrap, atomic existing-user onboarding, and module entitlement endpoints. Recovery and invitations remain future work. See [CORE-004 policy and limitations](core-004-authentication.md). Provider access, domains, recovery, and future module implementation remain unresolved as listed. Stop after CORE-006; this is not production readiness.
