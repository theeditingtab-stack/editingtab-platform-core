...
CORE-007 adds Core's side of a versioned internal authorization connection to the separate Booking application/database. It validates both service and user identity plus current organization permissions and entitlement. It does not implement the Booking client or inventory. See the [contract and explicit permission delegation policy](booking-authorization-contract.md).
