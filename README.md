...
- [CORE-AUTH-005 access context](docs/core-auth-005-access-context.md): authenticated identity, organization access, effective authorization, entitlements, and future Booking handoff.
